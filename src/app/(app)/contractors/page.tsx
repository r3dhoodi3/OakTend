...
export default async function ContractorsPage(
  ...
  return (
    <div className="space-y-8">
      <div>
        {/* The way to the jobs themselves. This used to be a phone-only jump
            link to a section further down THIS page; "Your jobs" is its own
            page now (/contractors/jobs), so it shows at every width - the
            whole point of the split was that the jobs were missable at the
            bottom of the posting form. Sits INSIDE this wrapper, not as a
            sibling: as a sibling it would take the parent's space-y-8 margin
            and push the h1 down. */}
        {openJobsCount > 0 && (
          <Link
      ...
      {/* Same Back-home link the page has always ended on. It stayed here
