...
// Referral rewards grant wallet credit built entirely on the retired wallet
// mechanic, so this cron is paused behind RETIRED_PRO_PROGRAMS_PAUSED
...
describe("referral-rewards cron while RETIRED_PRO_PROGRAMS_PAUSED is true", () => {
...
describe("referral-rewards cron once unpaused", () => {
