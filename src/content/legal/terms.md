...
**De-identified and aggregated data.** You also grant us a perpetual, worldwide, royalty-free license to create de-identified and aggregated data from the information you and your home generate on {{BRAND}}, and to use, publish, and license that de-identified data for any lawful purpose, including maintenance benchmarks, service-life statistics, market research, and product development. De-identified means the data has been produced as described in our Privacy Policy: your name, address, contact details, document contents, photos, and chat contents are never included, and the data is grouped so that no individual home is identifiable. We will not attempt to re-identify de-identified data, and we require anyone who receives it to agree to the same restriction, including a ban on reselling it or passing it to anyone else except under identical terms. This is not a sale of your personal information.
