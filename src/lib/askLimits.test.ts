...
describe("previewMeterLabel", () => {
  it("reads as a sentence with no mention of 'free'", () => {
    expect(previewMeterLabel(2, 20)).toBe("2 of 20 questions today");
...
describe("previewLockText", () => {
  it("names the limit without calling the questions free", () => {
    expect(previewLockText(20)).toBe(
      "That's your 20 questions for today. They reset tomorrow."
    );
    expect(previewLockText(20)).not.toContain("free");
